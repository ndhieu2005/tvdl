...
export default function SwaggerWrapperNew2({ spec }: SwaggerWrapperProps) {
  ...
  useEffect(() => {
    ...
    const initSwagger = async () => {
      try {
        ...
        setError('Error initializing SwaggerUI: ' + err);
      }
    };
