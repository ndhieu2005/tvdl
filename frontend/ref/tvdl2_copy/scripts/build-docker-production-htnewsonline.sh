...
# Example: ./build-docker-production.sh v1.0.0 registry.htnewsonline.site/htnewsonline-app

set -e

IMAGE_TAG=${1:-"latest"}
IMAGE_NAME=${2:-"registry.htnewsonline.site/htnewsonline-app"}
...
echo "🔗 Site URL: https://htnewsonline.com"
